...
| **37** | Derived from [CWE89_..._1983](https://samate.nist.gov/SARD/test-cases/1983/versions/1.0.0) | CWE-89 | SQL Injection | **Vulnerable** | Using input directly in SQL query. |
